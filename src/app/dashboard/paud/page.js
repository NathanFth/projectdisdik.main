...
export default function PaudPage() {
  // Logic toggle dihapus, sekarang menggunakan satu tampilan gabungan
  const operatorType = "PAUD"; 
  ...
  return (
    <>
      ...
      {/* Tombol toggle dihapus sesuai instruksi */}

      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-0 sm:p-6">
        <SchoolsTable key={operatorType} operatorType={operatorType} />
      </div>
    </>
  );
}