// src/app/dashboard/pkbm/[npsn]/page.js
"use client";
...
export default function PkbmDetailPage() {
  ...
  const loadDetail = useCallback(async () => {
    ...
    try {
      ...
      // 2. Fetch Data Kelas (Penting untuk struktur Paket A/B/C PKBM)
      // Format grade di DB biasanya: 'paketA_kelas1_L', dsb.
      ...
      // Transformer akan mendeteksi jenjang PKBM dan menyusun siswa ke dalam struktur Paket A/B/C
  ...
  const getEditHref = () => {
    if (!detail) return "#";
    // Untuk PKBM routingnya pasti ke folder /pkbm
    return `/dashboard/pkbm/edit/${npsnParam}`;
  };
